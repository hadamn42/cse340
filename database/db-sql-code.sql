...
--Create relationsihp between 'classification' and 'inventory' tables
...
-- Data for table `inventory` adding here just in case
...
--Updating hummer description
UPDATE public.inventory
	SET inv_description = REPLACE(inv_description, 'the small interiors', 'a huge interior')
    WHERE inv_id = 10;

-- Updating "inventory" inv_image & inv_thumbnail
UPDATE public.inventory
